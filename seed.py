...
def seed():
    ...
    """, (
        ...
        '企业',
        '0510-87654321',
        'legal@xinyuan-tech.com',
        '无锡市滨湖区太湖大道 88 号新源大厦',
        '91320211MA1XY12345',
        '长期合作客户，主营智能制造设备出口。法务联系人：王经理 13912345678'
    ))
    ...
    """, (
        ...
        120000.00,
        '部分收费',
        '委托人无锡新源科技有限公司与深圳海纳贸易有限公司于2025年3月签订设备采购合同，总价款258万元。委托人已按约交付全部设备，但对方至今仅支付首款50万元，余款208万元逾期未付。委托人多次催款无果，现委托我所代理诉讼。',
        '2026-03-15',
        '无锡新源科技有限公司',
        '王经理 13912345678',
        '未开票'
    ...
    timeline_events_case1 = [
        ...
        ('2026-03-25', '立案', '向无锡市滨湖区人民法院提交起诉状及证据材料，正式立案', '立案'),
        ('2026-04-10', '送达起诉状副本', '法院向被告深圳海纳贸易有限公司送达起诉状副本', '其他'),
    ...
    # 案例一跟进记录
    followups_case1 = [
        ('2026-03-15', '与王经理初次会面，了解案情基本情况，查阅合同及往来函件，初步评估胜诉可能性较大', '王经理', '13912345678', '已全面了解案情', '草拟起诉状及证据清单'),
        ('2026-04-20', '与被告方律师电话沟通和解可能性，对方表示需请示公司领导', '刘律师（对方）', '13800000000', '对方未明确表态，诉讼继续进行', '关注对方是否在期限内提交答辩状'),
        ('2026-06-15', '开庭前与委托人确认证据原件，进行模拟庭审演练，委托人配合度良好', '王经理', '13912345678', '庭审准备充分', '准时出庭'),
    ]
    ...
    """, (
        ...
        80000.00,
        '已收费',
        '委托人发现常州恒泰机械有限公司未经许可在其产品及宣传材料中使用与委托人注册商标近似的标识，涉嫌侵害注册商标专用权。经公证取证后提起诉讼。本案经中院主持调解，双方达成和解协议，被告停止侵权并赔偿损失。',
        '2025-08-01',
        '2025-12-20',
        '无锡新源科技有限公司',
        '王经理 13912345678',
    ...
    timeline_events_case2 = [
        ...
        ('2025-09-01', '立案', '向无锡市中级人民法院提交起诉状，正式立案', '立案'),
    ...
    # 案例二跟进记录
    followups_case2 = [
        ('2025-08-05', '与委托人收集商标注册证书、荣誉证书等权利证据，核实侵权范围', '王经理', '13912345678', '权利基础扎实', '尽快完成公证取证'),
        ('2025-11-15', '开庭后被告主动联系和解，提出50万元赔偿方案，征求委托人意见', '李律师（对方）', '13600000000', '谈判空间较大', '草拟和解方案'),
    ]
